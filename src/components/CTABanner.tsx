    ...
    <section className="pt-8 md:pt-12 pb-12 md:pb-32 px-6" style={{ backgroundColor: '#0A0A0A' }}>
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          {/* Derecha: titular */}
          <h2
            className="font-sans tracking-tight leading-[1.1] text-center md:text-right order-1 md:order-2"
            style={{
              fontFamily: "'Inter', sans-serif",
          ...
          >
            <span className="inline-flex flex-col items-center md:items-end gap-1">
