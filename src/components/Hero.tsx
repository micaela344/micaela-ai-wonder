    ...
    <section className="relative min-h-[calc(100vh-340px)] flex items-center justify-center overflow-hidden pt-16 md:pt-20 lg:pt-24 pb-12">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        >
          ...
          >
            <span style={{ fontWeight: 800, color: '#ffffff', textShadow: '0 1px 2px rgba(255,255,255,0.8), 1px 0 2px rgba(255,255,255,0.8), -1px 1px 2px rgba(255,255,255,1), 1px -1px 2px rgba(255,255,255,1), 1px 1px 2px rgba(255,255,255,1), -1px -1px 2px rgba(255,255,255,1), 0 0 5px rgba(255,255,255,1), 0 0 10px rgba(255,255,255,0.5), 0 0 20px rgba(255,255,255,0.5)' }}>Creatividad </span>
          ...
          >
            <span style={{ fontWeight: 800, color: '#ffffff', textShadow: '0 1px 2px rgba(255,255,255,1), 1px 0 2px rgba(255,255,255,0.8), -1px 1px 2px rgba(255,255,255,1), 1px -1px 2px rgba(255,255,255,1), 1px 1px 2px rgba(255,255,255,1), -1px -1px 2px rgba(255,255,255,1), 0 0 5px rgba(255,255,255,1), 0 0 10px rgba(255,255,255,0.5), 0 0 20px rgba(255,255,255,0.5)' }}>Estrategia </span>
