    ...
    <section className="pt-28 pb-24">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-4"><span className="whitespace-pre">Imágenes   Animaciones   Campañas</span></h1>
          <p className="text-3xl md:text-4xl font-bold text-foreground mb-6">Contenido visual profesional generado con IA - sin estudio, sin fotógrafo, sin límites.</p>
